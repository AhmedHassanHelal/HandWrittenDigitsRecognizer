...
index = random.randrange(0, len(images_train_orig))
...
d = model(X_train, Y_Expected_Train, X_test, Y_Expected_Test, num_iterations = 600, learning_rate = 0.00001, print_cost = False)


my_image = (X_train[:, index]).reshape(X_train.shape[0], 1)
